...
export default function TikTok() {
    return (
        <section
            id='tiktok'
            className="bg-bg py-10 lg:py-20 lg:px-20 font-Lexend">
            <div className="mx-auto w-container max-w-full pb-10">
                <h2 className="text-center text-4xl font-heading lg:text-5xl font-Rocket">
            ...
            <div className="mx-auto grid w-container max-w-full grid-cols-1 gap-5 px-8 lg:px-[20] sm:grid-cols-1 lg:grid-cols-2">
                <div className="relative flex items-center justify-center lg:col-span-1">
                    <Image
                        ...
                        src={tiktokShot}
                        alt="Perfil de TikTok"
                        height={500}
                    />

                    <div className="absolute bottom-10 right-20 lg:right-48 bg-white border-4 border-black p-4 rounded-lg shadow-[8px_8px_0px_#FF8ACD]">
