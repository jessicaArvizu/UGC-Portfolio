...
export default function Header() {
  ...
  return (
    <header className="inset-0 pt-16 p-10 lg:pt-36 flex w-full flex-col items-center justify-center bg-[#FF8ACD] bg-[linear-gradient(to_right,#FFC6E733_2px,transparent_1px),linear-gradient(to_bottom,#FFC6E733_2px,transparent_1px)] bg-[size:70px_70px]">
